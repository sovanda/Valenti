 ...
 */
 ...
 function cb_extra_plugins_fire_up() {
	...
	$plugins = array(
		...
		array(
            'name'                  => 'Cubell Themes Functionality', // The plugin name
            'slug'                  => 'cubell-themes-functionality', // The plugin slug (typically the folder name)
            'source'                => get_template_directory() . '/library/extensions/cubell-themes-functionality.zip', // The plugin source
        ...
        array(
            ...
            'source'                => get_template_directory() . '/library/extensions/envato-wordpress-toolkit.zip', // The plugin source
