...
?>
        <article id="post-<?php the_ID(); ?>" class="cb-blog-style-c clearfix<?php if (is_sticky()) { echo ' sticky'; } echo $cb_side; if ( $cb_category_color_style != NULL ) { echo ' ' . $cb_category_color_style; } ?>" role="article">
