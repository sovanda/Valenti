		...
		<div id="merge-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-merge">
			...
			<form id="merge_topic" name="merge_topic" method="post" action="<?php the_permalink(); ?>">
				...
				<fieldset class="bbp-form">
					...
					<div class="entry-title"><?php printf( __( 'Merge topic "%s"', 'bbpress' ), bbp_get_topic_title() ); ?></div class="entry-title">
					...
					<div>
						...
						<fieldset class="bbp-form">
							<div class="entry-title"><?php _e( 'Destination', 'bbpress' ); ?></div class="entry-title">
							<div>
						...
						<fieldset class="bbp-form">
							<div class="entry-title"><?php _e( 'Topic Extras', 'bbpress' ); ?></div class="entry-title">
							...
							<div>
								...
								<?php if ( bbp_allow_topic_tags() ) : ?>
									...
									<input name="bbp_topic_tags" id="bbp_topic_tags_merge" type="checkbox" value="1" checked="checked" tabindex="<?php bbp_tab_index(); ?>" />
